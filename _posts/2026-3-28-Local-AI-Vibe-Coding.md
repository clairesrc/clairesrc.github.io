...
- OS: This doesn’t really matter, as long as it’s Linux 😉 I find NixOS provides a huge step up in granting AI agents the ability to experiment with and iterate over a system’s software setup, so to me, NixOS is indispensable if I want to be able to move fast.
